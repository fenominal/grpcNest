...
export namespace Project1Types {
...
export type PROJECT1__EnumType__PAYMENT_SYSTEM =
  ...
  /** undefined **/
  PROJECT1_PROJECT1Service_getFirstquery: InContextSdkMethod<Query['PROJECT1_PROJECT1Service_getFirstquery'], QueryPROJECT1_PROJECT1Service_getFirstqueryArgs, MeshContext>,
  /** undefined **/
  ...
  export type Context = {
      ["PROJECT1"]: { Query: QuerySdk, Mutation: MutationSdk, Subscription: SubscriptionSdk },
